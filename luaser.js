...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:𝔸𝕄𝕁 𝕊𝔼ℝ OFC\n'
            + 'ORG:Owner LUA;\n'
            + 'TEL;type=CELL;type=VOICE;waid=917306149125:+917306149125\n'
            + 'END:VCARD'
...
memberLimit = 1
ban = []
premium = ["917306149125@s.whatsapp.net","917306149125@s.whatsapp.net"]
...
🥳 WELCOME 🫂`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const DnsBot = ["917306149125@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["917306149125@s.whatsapp.net","15749993995@s.whataapp.net"] // owner number ubah aja
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `ᴍᴀᴀғ 𝓐𝓜𝓙 𝓢𝓔𝓡 ᴛɪᴅᴀᴋ ʙɪꜱᴀ ᴍᴀꜱᴜᴋ ɢʀᴏᴜᴘ ᴋᴀʀɴᴀ ᴍᴇᴍʙᴇʀ ɢʀᴏᴜᴘ *${groupMetadata.subject}* ᴛɪᴅᴀᴋ ᴍᴇᴍᴇɴᴜʜɪ ʟɪᴍɪᴛ ᴍᴇᴍʙᴇʀ\n\nᴍɪɴɪᴍᴀʟ ᴍᴇᴍʙᴇʀ *${memberLimit}*`, text)
					setTimeout( () => {
		...
		setTimeout( () => {
		reply(`ᴍᴀᴀғ 𝓐𝓜𝓙 𝓢𝓔𝓡 ꜱᴇɢᴇʀᴀ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
...
denz.sendMessage(from, dmenu, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "mwonu   𝓐𝓜𝓙 𝓢𝓔𝓡❤️", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('amjadali.jpg')}}}})
denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true}) 	    
            break
            case 'menu2':
			if (isBanned) return reply(mess.only.benned)
				...
				case 's':
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								denz.sendMessage(from, buff, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "𝓐𝓜𝓙 𝓢𝓔𝓡", 'jpegThumbnail': fs.readFileSync('./sticker/amjadsticker.webp')}}}})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
...
// last
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						denz.sendMessage(from, buffer, image, {quoted: mek, caption: '𝓐𝓜𝓙 𝓢𝓔𝓡'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
  ...
  break
			...
			if (!isUser) return reply(mess.only.userB)
				...
				break
					...
					mentions(teks, membr, true)
					break
case 'igstory'://𝔸𝕄𝕁 𝕊𝔼ℝ////𝐁𝐋𝐀𝐂𝐊 𝐓𝐇𝐔𝐍𝐃𝐄𝐑
...
await limitAdd(sender)
break
case 'silveryt'://𝔸𝕄𝕁 𝕊𝔼ℝ////𝐁𝐋𝐀𝐂𝐊 𝐓𝐇𝐔𝐍𝐃𝐄𝐑
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
lsu1 = body.slice(11)
reply(mess.wait)
...
await limitAdd(sender)
break
case 'goldyt'://𝔸𝕄𝕁 𝕊𝔼ℝ////𝐁𝐋𝐀𝐂𝐊 𝐓𝐇𝐔𝐍𝐃𝐄𝐑
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
lsu = body.slice(9)
reply(mess.wait)
...
case 'attp':
                if (isBanned) return reply(mess.only.benned)    
                if (!isUser) return reply(mess.only.userB)
                if (args.length < 1) return reply(`Example: ${prefix} 𝔸𝕄𝕁 𝕊𝔼ℝ`)
                dapuhy = body.slice(5)
...
┗━━━━━━━━━━━━━━━`, text, { quoted: mek})
         ...
         case 'lirik':
                ...
                if (args.length < 1) return reply(`Yang mau direport apaan? Contoh: #report fitur #hentai error`)
                    ...
                    denz.sendMessage('917306149125@s.whatsapp.net', options, text, {quoted: mek})
...
case 'husbu':
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝓐𝓜𝓙 𝓢𝓔𝓡_", 'jpegThumbnail': fs.readFileSync('./sticker/amjadsticker.webp')}}}})
        }
		...
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Sneham.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("Shiyaf")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Shiyaf.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("Rashidpro")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Rashidpro.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("@7306149125")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/@7306149125.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("Abhinavinuphonilla")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Abhinavinuphonilla.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("Djsong")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Djsong.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("Thilakan")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Thilakan.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("Sukumaran")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Sukumaran.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("Kgf")){
		denz.updatePresence(from, Presence.composing)
        ...
        if (budy.includes("917306149125")){  // respon tag ubah aja
        reply(`OI *${pushname2}*, നീ എന്തിനാടോ എന്റെ അംജദ് സാറിനെ മെൻഷൻ അടിച്ചത് നീ ആരാ നീ ഏതാ മെൻഷൻ അടിക്കണങ്കിൽ നിനക്ക് കുറച്ചു പെവറിന്റെ ആവശ്യമുണ്ട്!`)
        const d = fs.readFileSync('./sticker/tag.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝓐𝓜𝓙 𝓢𝓔𝓡_", 'jpegThumbnail': fs.readFileSync('./sticker/amjadsticker.webp')}}}})
        }
        if (budy.includes("𝔸𝕄𝕁 𝕊𝔼ℝ")){  // respon tag ubah aja
        reply(`*${pushname2}*, ɴɢᴀᴘᴀɪɴ ᴄᴀʟʟɪɴɢ² ᴏᴡɴᴇʀ ᴏɴʟʏ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝓐𝓜𝓙 𝓢𝓔𝓡_", 'jpegThumbnail': fs.readFileSync('./sticker/amjadsticker.webp')}}}})
        }
        if (budy.includes("Amjad")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Amjad.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("Amjadali")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/Amjadali.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
		if (budy.includes(`Thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, sɪs *${pushname2}*, 𝓐𝓜𝓙 𝓢𝓔𝓡 >-<`)
                  }
